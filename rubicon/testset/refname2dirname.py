...
def refname2dirname(mission):
    ...
    fw_name_2_path = {m['user_tags']['fw_name'].strip(): m['path'] for m in
                      calc_result}
    ...
    ref2path = {ref_name: fw_name_2_path[fw_name] for ref_name, fw_name in
                ref2gau.items() if fw_name in fw_name_2_path}
...
if __name__ == '__main__':
    ...
    shuyue_ref2path = refname2dirname(
        'G2-97 Test Set Benchmark (Shyue Scheme)')
