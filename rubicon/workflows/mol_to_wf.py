...
def mol_to_wf_nwchem(mol, name):
    ...
    tasks = [
        NwTask.dft_task(mol, operation="optimize", xc="b3lyp",
                        basis_set="6-31++G*", theory_directives={"odft": "", "iterations": 300})]
    ...
    tasks += [
        NwTask.dft_task(mol, operation="energy", xc="b3lyp",
                        basis_set="6-311++G**", theory_directives={"odft": "", "iterations": 300}),
        NwTask.dft_task(mol, charge=mol.charge + 1, operation="energy",
                        xc="b3lyp", basis_set="6-311++G**", theory_directives={"odft": "", "iterations": 300}),
        NwTask.dft_task(mol, charge=mol.charge - 1, operation="energy",
                        xc="b3lyp", basis_set="6-311++G**", theory_directives={"odft": "", "iterations": 300})
    ]
