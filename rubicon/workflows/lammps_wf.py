...
if __name__ == '__main__':
    ...
    tfn = Molecule(
        ["O", "F", "C", "S", "O", "F", "N", "O", "F", "S", "O", "F", "F", "C",
         "F"], coords_tfn,
        site_properties={"mol_name": ["TFN"] * len(coords_tfn)})
    n1c = Molecule(
        ["C", "C", "H", "C", "H", "N", "N", "C", "H", "H", "H", "C", "H", "H",
         "C", "H", "H", "H", "C", "H", "H", "H"], coords_n1c,
        site_properties={"mol_name": ["N1C"] * len(coords_n1c)})
    pc = Molecule(
        ["C", "C", "O", "H", "H", "C", "O", "O", "C", "H", "H", "H", "H"],
        coords_pc, site_properties={"mol_name": ["PC"] * len(coords_pc)})
    acn = Molecule(["C", "C", "H", "H", "H", "N"], coords_acn,
                   site_properties={"mol_name": ["ACN"] * len(coords_acn)})
    mg = Molecule(["Mg"], coords_mg,
                  site_properties={"mol_name": ["MAG"] * len(coords_mg)})
    al = Molecule(["Al"], coords_al,
                  site_properties={"mol_name": ["ALU"] * len(coords_al)})
    cl = Molecule(["Cl"], coords_cl,
                  site_properties={"mol_name": ["CHL"] * len(coords_cl)})
    thf = Molecule(
        ["C", "C", "C", "H", "H", "C", "H", "H", "O", "H", "H", "H", "H"],
        coords_thf, site_properties={"mol_name": ["THF"] * len(coords_thf)})
    tfsi = Molecule(
        ["N", "S", "O", "O", "C", "F", "F", "F", "S", "O", "O", "C", "F", "F",
         "F"], coords_tfsi,
        site_properties={"mol_name": ["tfsi"] * len(coords_tfsi)})
    diglyme = Molecule(
        ["O", "C", "C", "C", "C", "O", "O", "C", "C", "H", "H", "H", "H", "H",
         "H", "H", "H", "H", "H", "H", "H", "H", "H"], coords_diglyme,
        site_properties={"mol_name": ["diglyme"] * len(coords_diglyme)})
