    ...
    def build_reaction_data(self, docs, reaction, solution_phase=True):
        ...
        for side, freq_and_sps, counts, nicknames in zip(["reactant", "product"],
            ...
            for n, nickname, freq_and_sp in zip(counts, nicknames, freq_and_sps):
                ...
                specie["snlgroup_id_final"] = freq_and_sps[0]["snlgroup_id_final"]
                specie["charge"] = freq_and_sps[0]["charge"]
                specie["spin_multiplicity"] = freq_and_sps[0]["spin_multiplicity"]
                specie["snl_final"] = freq_and_sps[0]["snl_final"]
                specie["molecule"] = freq_and_sps[0]["molecule"]
                specie["xyz"] = freq_and_sps[0]["xyz"]
                specie["inchi"] = freq_and_sps[0]["inchi"]
                specie["can"] = freq_and_sps[0]["inchi"]
                specie["smiles"] = freq_and_sps[0]["smiles"]
                specie["inchi_root"] = freq_and_sps[0]["inchi_root"]
                specie["elements"] = freq_and_sps[0]["elements"]
                specie["nelements"] = freq_and_sps[0]["nelements"]
                specie["user_tags"] = freq_and_sps[0]["user_tags"]
                specie["run_tags"] = freq_and_sps[0]["run_tags"]
                specie["reduced_cell_formula_abc"] = freq_and_sps[0]["reduced_cell_formula_abc"]
                specie["pretty_formula"] = freq_and_sps[0]["pretty_formula"]
                specie["formula"] = freq_and_sps[0]["formula"]
                specie["pointgroup"] = freq_and_sps[0]["pointgroup"]
                specie["svg"] = freq_and_sps[0]["svg"]
