...
class TestQChemFireWorkCreator(TestCase):
    def skip_get_dielectric_constant(self):
        ...
        dielectric, probe_radius, solvent_name = QChemFireWorkCreator.get_dielectric_constant(
            solvent)
        ...
        self.assertEqual(solvent_name,
                         "30.00% ethylenecarbonate, 70.00% ethylmethylcarbonate in volume")
