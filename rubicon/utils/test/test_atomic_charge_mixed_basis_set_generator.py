...
class TestAtomicChargeMixedBasisSetGenerator(TestCase):
    def setUp(self):
        self.generator = AtomicChargeMixedBasisSetGenerator(
    ...
    def test_get_basis(self):
        ...
        ans = [('C', '6-31G*'), ('C', '6-31G*'), ('C', '6-31G*'),
               ('C', '6-31G*'),
               ('C', '6-31G*'), ('C', '6-31G*'), ('H', '6-31G*'),
               ('H', '6-31G*'),
               ('H', '6-31G*'), ('H', '6-31G*'), ('C', '6-31G*'),
               ('C', '6-31G*'),
    ...
    def test_to_and_from_dict(self):
        g1 = AtomicChargeMixedBasisSetGenerator(
            charge_threshold=-0.2, normal_basis_set="cc-PVDZ",
            diffuse_basis_set="aug-cc-PVDZ")
