...
def go_submissions():
    m_description = 'This program is used to pull jobs from the Submissions database, ' \
                    'create FireWorks workflows from those submissions, and then monitor ' \
                    'all previous submissions for updates to state (so that the submission ' \
