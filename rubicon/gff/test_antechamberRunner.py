...
class TestAntechamberRunner(TestCase):
    ...
    def test_get_ffmol(self):
        ...
        gff_masses='''
{'sy': 32.06, 'f': 19.0, 'ne': 14.01, 'o': 16.0, 's6': 32.06, 'c3': 12.01}
{'cc': 12.01, 'na': 14.01, 'h1': 1.008, 'h4': 1.008, 'cd': 12.01, 'c3': 12.01, 'hc': 1.008}
{'c': 12.01, 'h1': 1.008, 'o': 16.0, 'c3': 12.01, 'hc': 1.008, 'os': 16.0}
'''


        self.assertEquals(gff_masses,m)
