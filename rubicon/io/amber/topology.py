...
class Topology(object):
    ...
    def __init__(self, atoms, charges, bonds, angles, dihedrals, imdihedrals, num_bonds,
                 num_gaff_atoms, gaff_atoms):
    ...
    def from_file(cls, filename, continue_on_corrupt_file=False):
        ...
        with open(filename) as f:
            ...
            return Topology(atoms, charges, bonds, angles, dihedrals,
