...
class LammpsForceFieldData(LammpsData):
    ...
    Args:
        ...
        box_size (list): size of the box that embeds the packed molecule.
            [x_min, y_min, z_min, x_max, y_max, z_max]
        molecule (Molecule): the packed molecules generated by the
    ...
    def __init__(self, mols, mols_number, box_size, molecule, forcefields, topologies):
        self.mols = mols
    ...
    def _set_system_info(self):
        ...
        for ff, top in zip(self.forcefields, self.topologies):
            ...
            if ff.dihedrals:
                self.ndih_types += len(ff.dihedrals)
            if top.dihedrals:
    ...
    def _get_param_coeff(self, obj, param_name, offset):
        """
        generalized method to set the parameter coefficients from the mapping
