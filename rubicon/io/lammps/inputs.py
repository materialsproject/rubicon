...
class LammpsData(object):
    ...
    Args:
        ...
        box_lengths (list): the lengths in x, y and z directions.
    """
    def __init__(self, molecule, box_lengths):
    ...
    def write_data_file(self, filename):
        ...
        with open(filename, "w") as f:
            f.writelines("Data file generated by rubicon\n")
            f.write("\n")
            f.write("{} atoms\n".format(len(self.boxed_molecule)))
            f.write("\n")
            f.write("{} atom types\n".format(len(self.boxed_molecule.symbol_set)))
            f.write("\n")
            f.write("{} {} xlo xhi\n".format(0, self.boxed_molecule.lattice.a))
            f.write("{} {} ylo yhi\n".format(0, self.boxed_molecule.lattice.b))
            f.write("{} {} zlo zhi\n".format(0, self.boxed_molecule.lattice.c))
            f.write("\n\n")
            f.write("Atoms \n\n")
            for i, site in enumerate(self.boxed_molecule):
                atom_type = self.boxed_molecule.symbol_set.index(site.species_string)
                if hasattr(site, "charge"):
                    f.write(
                        "{} {} {} {} {} {}\n".format(i + 1, atom_type + 1,
                                                   site.charge, site.x,
                                                   site.y, site.z))
                else:
                    f.write("{} {} {} {} {}\n".format(i+1, atom_type+1, site.x,
                                                site.y, site.z))
